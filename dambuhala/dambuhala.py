...
## 1.1 RESERVOIR DEPTH-AREA-VOLUME CURVE

## 1.2 BREACH DISCHARGE

### 1.2.1 PEAK DISCHARGE
...
class hydrograph_BetaDist:
    """
    Class for creating a hydrograph from the estimates of total volume and peak discharge, 
